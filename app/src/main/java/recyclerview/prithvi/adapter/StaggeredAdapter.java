 ...
 */
public class StaggeredAdapter extends RecyclerView.Adapter<StaggeredAdapter.ViewHolderUnsplash>{

    private LayoutInflater layoutInflater;
    private ArrayList<UnsplashData> unsplashList = new ArrayList<>();
    private Context context;

    public StaggeredAdapter(ArrayList<UnsplashData> unsplashList, Context context){
    ...
    public ViewHolderUnsplash onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.adapter_staggered, parent, false);
